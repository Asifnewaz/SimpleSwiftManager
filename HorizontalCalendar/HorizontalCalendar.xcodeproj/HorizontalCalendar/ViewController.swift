...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let cellDate = currentCellDate {
            ...
            print(cellDate)
            if self.selectedDateByUser == cellDate {
                cell.DayOfMonthLabel.backgroundColor = UIColor.yellow
                cell.DayOfMonthLabel.textColor = UIColor.white
            } else if cellDate < Date().dayBefore {
                cell.DayOfWeekLabel.textColor = UIColor.gray
                cell.DayOfMonthLabel.textColor = UIColor.gray
                cell.DayOfMonthLabel.backgroundColor = UIColor.clear
            } else {
                cell.DayOfWeekLabel.textColor = UIColor.black
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if let cell = collectionView.cellForItem(at: indexPath) as? DateCollectionViewCell {
            ...
            self.selectedDateByUser = cell.date!
