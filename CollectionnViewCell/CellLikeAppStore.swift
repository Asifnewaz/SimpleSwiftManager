...
//  https://github.com/M-I-N/appstore-clone
//
...
internal class BaseCollectionViewCell: UICollectionViewCell {
    ...
    private func configureShadow() {
        ...
        let shadowView = UIView(frame: CGRect(x: BaseCollectionViewCell.kInnerMargin,
                                              y: BaseCollectionViewCell.kInnerMargin,
                                              width: bounds.width - (2 * BaseCollectionViewCell.kInnerMargin),
                                              height: bounds.height - (2 * BaseCollectionViewCell.kInnerMargin)))
